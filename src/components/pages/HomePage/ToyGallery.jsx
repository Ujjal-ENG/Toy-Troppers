        ...
        <div className="mb-14">
            <section className="text-gray-600 body-font">
                <div className="container px-5 pb-32 mx-auto flex flex-wrap">
                    <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" className="flex w-full my-20 flex-wrap">
                    ...
                    <div className="flex flex-wrap md:-m-2 -m-1">
                        <div className="flex flex-wrap w-1/2">
                            <div data-aos="fade-flip" data-aos-offset="300" data-aos-easing="ease-in-sine" className="md:p-2 p-1 w-1/2">
                                <img
                                    alt="gallery"
                            ...
                            <div data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" className="md:p-2 p-1 w-1/2">
                                <img
                                    alt="gallery"
                                    className="w-full object-cover h-full object-center block"
                            ...
                            <div data-aos="zoom-in" data-aos-offset="300" data-aos-easing="ease-in-sine" className="md:p-2 p-1 w-full">
                                <img
                                    alt="gallery"
                        ...
                        <div className="flex flex-wrap w-1/2">
                            <div data-aos="zoom-in-up" data-aos-easing="ease-in-out" data-aos-once="false" data-aos-anchor-placement="top-center" className="md:p-2 p-1 w-full">
                                <img
                                    alt="gallery"
                                    className="w-full h-full object-cover object-center block"
                            ...
                            <div data-aos="zoom-in-down" data-aos-easing="ease-in-out" data-aos-once="false" data-aos-anchor-placement="top-center" className="md:p-2 p-1 w-1/2">
                                <img
                                    alt="gallery"
                                    className="w-full object-cover h-full object-center block"
                            ...
                            <div data-aos="zoom-in-right" data-aos-easing="ease-in-out" data-aos-once="false" data-aos-anchor-placement="top-center" className="md:p-2 p-1 w-1/2">
